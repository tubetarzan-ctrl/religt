            ...
            {events.map((event, i) => {
              ...
              return (
                <FadeIn key={event.id} delay={i * 0.06}>
                  <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-surface shadow-card transition-all hover:-translate-y-1.5 hover:shadow-card-lg">
                    <div
