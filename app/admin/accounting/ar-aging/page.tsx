...
export default async function ArAgingPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-heading text-2xl text-brand-text">Accounts Receivable Aging</h1>
        <p className="text-sm text-brand-text-muted">Outstanding customer balances by age.</p>
      </div>
